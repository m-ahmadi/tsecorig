...
// Type: TseClient.ServerSerive.InstrumentAndShareCompletedEventHandler
...
namespace TseClient.ServerSerive {
	...
	public delegate void InstrumentAndShareCompletedEventHandler(
		object sender,
		InstrumentAndShareCompletedEventArgs e);
}
