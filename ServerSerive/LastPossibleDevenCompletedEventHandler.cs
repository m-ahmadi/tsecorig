...
// Type: TseClient.ServerSerive.LastPossibleDevenCompletedEventHandler
...
namespace TseClient.ServerSerive {
	...
	public delegate void LastPossibleDevenCompletedEventHandler(
		object sender,
		LastPossibleDevenCompletedEventArgs e);
}
